...
def evaluation_list_dicts(list_dicts, model_contents=r"Models\Contents\pipeline_contents_One-Many_V2-07-04.sav", model_determinants=r"Models\Determinants\pipeline_determinants_One-Many_V2-07-04.sav"):
